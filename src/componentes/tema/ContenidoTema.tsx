...
// Al cambiar de uno a otro el vidrio se despeja y el contenido crece en su lugar: se
// siente como algo que se abre, no como otra pantalla. Los `layout` hacen que el alto
// cambie sin saltos; el contenido interno también lo lleva para no estirarse.
export default function ContenidoTema({ tema }: { tema: TemaVisible }) {
  return (
    <motion.div layout transition={{ layout: transicionLayout }}>
      <AnimatePresence mode="wait" initial={false}>
        {tema.acceso === 'abierto' ? (
          <motion.div key="abierto" layout variants={revelar} initial="oculto" animate="visible" exit="salida">
