...
const capas = [
  { fondo: 'fill-mar-espuma', trazo: 'M0 60 Q150 18 300 60 T600 60 T900 60 T1200 60 V140 H0Z', seg: 24, opacidad: 'opacity-90' },
  { fondo: 'fill-mar-cielo', trazo: 'M0 78 Q150 44 300 78 T600 78 T900 78 T1200 78 V140 H0Z', seg: 38, opacidad: 'opacity-80' },
]
